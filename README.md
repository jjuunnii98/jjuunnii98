...
## 1) End-to-End ML Analytics System
👉 https://github.com/jjuunnii98/end-to-end-ml-analytics-system

A production-oriented ML system demonstrating the full lifecycle of machine learning development.

**Highlights**
- End-to-end ML workflow from raw data to model serving
- Modular project architecture for production-style development
- Reproducible training, evaluation, and pipeline design
...
## 3) Crypto Risk Intelligence Pipeline
