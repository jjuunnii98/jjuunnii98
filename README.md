...
- Healthcare AI (Survival Analysis, Risk Prediction)  
- Financial AI (Crypto Market Intelligence)  
...
- Machine Learning Systems (training → inference → API)
- Data Engineering (data pipelines, preprocessing)
- Backend Development (FastAPI)
- SQL & Database Design
- Linux-based development environments
- Git-based workflow and reproducibility
...
JUNIXION is an AI initiative focused on **risk-aware decision systems**.
